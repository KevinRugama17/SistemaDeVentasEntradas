...
public class LoginController implements Initializable{
            ...
            if (gestor.validarLogin(id, password)) {
                ...
                FXMLLoader loader = new FXMLLoader(
                    getClass().getResource(
                        "/com/mycompany/sistemadeventasentradas/FXML/MainView.fxml"
                    )
                );
    ...
    private void validarCampos(String id, String password) throws CamposVaciosException {
        if (id.isEmpty() || password.isEmpty()) {
            throw new CamposVaciosException("El ID o la contraseña no pueden estar vacíos.");
        }
    }
 ...
 //============================================================
 //este es el codigo de Joel, usted decide si quiere elimnarlo.|
 // ===========================================================
    /*
    @FXML
